		...
		grid.jqGrid({ 
			         ...
			         colModel :[   
			                    ...
			                    {name:'srf_ratesign', index:'currency',  align:'center', editable:true, sortable:true, hidden:true, 
			                    	 edittype:'select',
			       				     editoptions:{value:{0:'--- Select Currency --- ',$:'$',Rs:'Rs',Euro:'Euro',NA:' Not Available',TBA:'TBA'}},
			       				     editrules:{edithidden:true},	
			                    ...
			                    {name:'srf_shipment', index:'shipment',  align:'center', editable:true, sortable:true, hidden:true, 
			                      edittype:'select',
			                      editoptions:{value:{0:'--- Select Shipment --- ',Air:'Air',Sea:'Sea',Courier:'Courier',Truck:'Truck',Train:'Train',Fob:'Fob',Local:'Local',ExChennai:'Ex Chennai',ExRanipet:'Ex Ranipet',ExFactory:'Ex-Factory',NA:'NA',TBA:'TBA'}},
			       			      editrules:{edithidden:true},	
			                    ...
			                    {name:'srf_tapetest', index:'tapetest', align:'center', editable:true, sortable:true, hidden:true, 
			                    	 edittype:'select',
				       			      editoptions:{value:{0:'--- Select tapetest --- ',APC:'As per Cutting',APS:'As per swatch',Good:'Good',Medium:'Medium',NA :'NA',TBA:'TBA'}},
				       			      editrules:{edithidden:true},	
				       			   formoptions:{rowpos: 8, colpos: 2},
			                    },  
			                    {name:'srf_crockwet', index:'crockingwet', align:'center', editable:true, sortable:true, hidden:true, 
			                    	 edittype:'select',
				       			      editoptions:{value:{0:'--- Select crockingwet --- ',APC:'As per Cutting',APS:'As per swatch',Good:'Good',NA :'NA',TBA:'TBA'}},
				       			      editrules:{edithidden:true},	
				       			   formoptions:{rowpos: 8, colpos: 3},
			                    },  
			                    {name:'srf_crockdry', index:'crockingdry', align:'center', editable:true, sortable:true, hidden:true, 
			                    	 edittype:'select',
				       			      editoptions:{value:{0:'--- Select crockingdry --- ',APC:'As per Cutting',APS:'As per swatch',Good:'Good',NA :'NA',TBA:'TBA'}},
				       			      editrules:{edithidden:true},	
				       			   formoptions:{rowpos: 9, colpos: 1},
			                    }, 
			                    {name:'srf_fourfold', index:'fourfolds',  align:'center', editable:true, sortable:true, hidden:true, 
			                    	 edittype:'select',
				       			      editoptions:{value:{0:'--- Select fourfolds --- ',Required:'Required',NA:'NA',TBA:'TBA'}},
				       			      editrules:{edithidden:true},	

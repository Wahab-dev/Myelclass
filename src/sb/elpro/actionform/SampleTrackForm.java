 ...
 *
 */
public class SampleTrackForm extends ActionForm implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 3375110428487728449L;
	...
	private String forwaderid;
	private String isinvraised;
	
	
	private String articleid;
	private String articletype;
	private String articleshform;
	...
	/**
	 * @return the forwaderid
	 */
	public String getForwaderid() {
		return forwaderid;
	}
	/**
	 * @param forwaderid the forwaderid to set
	 */
	public void setForwaderid(String forwaderid) {
		this.forwaderid = forwaderid;
	}
	/**
	...
	/**
	 * @return the articleshform
	 */
	public String getArticleshform() {
		return articleshform;
	}
	/**
	 * @param articleshform the articleshform to set
	 */
	public void setArticleshform(String articleshform) {
		this.articleshform = articleshform;
	}
	/**
	...
	/**
	 * @return the courierdetails
	 */
	public String getCourierdetails() {
		return courierdetails;
	}
	/**
	 * @param courierdetails the courierdetails to set
	 */

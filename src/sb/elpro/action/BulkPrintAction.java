 ...
 *
 */
public class BulkPrintAction extends Action {
	/* (non-Javadoc)
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		if(type.equalsIgnoreCase("pdf")){
	        ...
	        JasperReport report = JasperCompileManager.compileReport("C:/Users/meetw_000/Desktop/report/SampleTrack/BulkTrack.jrxml");
			...
			response.setHeader("Content-Disposition", "attachment; filename=BulkOld.xls");
	        ServletOutputStream output = response.getOutputStream();

	        	JasperReport report = JasperCompileManager.compileReport("C:/Users/meetw_000/Desktop/report/SampleTrack/BulkTrackOld.jrxml");
	            HashMap<String, Object> params = new HashMap<String, Object>(); 
			...
			response.setContentType("application/ms-excel"); 
			response.setHeader("Content-Disposition", "attachment; filename=Bulk.xls");
	        ServletOutputStream output = response.getOutputStream();

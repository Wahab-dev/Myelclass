 ...
 *
 */
public class SampleDebBean implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = -7823463419258861060L;
	...
	private String samdeb_bankcharge;
	private String sampleinvactionform;
	private String samdeb_realizedamt;
	private String samdeb_exchngrate;
	private String samdeb_amtininr;
	private String samdeb_debdt;
	...
	/**
	 * @return the samdeb_bankcharge
	 */
	public String getSamdeb_bankcharge() {
		return samdeb_bankcharge;
	}
	/**
	 * @param samdeb_bankcharge the samdeb_bankcharge to set
	 */
	public void setSamdeb_bankcharge(String samdeb_bankcharge) {
		this.samdeb_bankcharge = samdeb_bankcharge;
	}
	/**
	...
	/**
	 * @return the samdeb_realizedamt
	 */
	public String getSamdeb_realizedamt() {
		return samdeb_realizedamt;
	}
	/**
	 * @param samdeb_realizedamt the samdeb_realizedamt to set
	 */
	public void setSamdeb_realizedamt(String samdeb_realizedamt) {
		this.samdeb_realizedamt = samdeb_realizedamt;
	}
	/**
	 * @return the samdeb_exchngrate
	 */
	public String getSamdeb_exchngrate() {
		return samdeb_exchngrate;
	}
	/**
	 * @param samdeb_exchngrate the samdeb_exchngrate to set
	 */
	public void setSamdeb_exchngrate(String samdeb_exchngrate) {
		this.samdeb_exchngrate = samdeb_exchngrate;
	}
	/**
	 * @return the samdeb_amtininr
	 */
	public String getSamdeb_amtininr() {
		return samdeb_amtininr;
	}
	/**
	 * @param samdeb_amtininr the samdeb_amtininr to set
	 */
	public void setSamdeb_amtininr(String samdeb_amtininr) {
		this.samdeb_amtininr = samdeb_amtininr;
	}
	/**
	 * @return the samdeb_debdt
	 */
	public String getSamdeb_debdt() {
		return samdeb_debdt;
	}
	/**
	 * @param samdeb_debdt the samdeb_debdt to set
	 */
	public void setSamdeb_debdt(String samdeb_debdt) {
		this.samdeb_debdt = samdeb_debdt;
	}
	/**
	 * @return the samdeb_remarks
	 */
	public String getSamdeb_remarks() {
		return samdeb_remarks;
	}
	/**
	 * @param samdeb_remarks the samdeb_remarks to set
	 */
	public void setSamdeb_remarks(String samdeb_remarks) {
		this.samdeb_remarks = samdeb_remarks;
	}
}

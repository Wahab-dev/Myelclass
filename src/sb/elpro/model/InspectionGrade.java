 ...
 *
 */
public class InspectionGrade implements Serializable {
	...
	/**
	 * @param percent3 the percent3 to set
	 */
	...
	/**
	 * @param percent4 the percent4 to set
	 */
	...
	/**
	 * @param comment4 the comment4 to set
	 */
	...
	/**
	 * @param percent5 the percent5 to set
	 */
	...
	/**
	 * @param comment5 the comment5 to set
	 */
	...
	/**
	 * @param percent6 the percent6 to set
	 */
	...
	/**
	 * @param comment6 the comment6 to set
	 */

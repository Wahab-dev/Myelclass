 ...
 *
 */
public class SrfArticle implements Serializable {
	...
	/**
	 * @return the srf_articleshform
	 */
	public String getSrf_articleshform() {
		return srf_articleshform;
	}
	/**
	 * @param srf_articleshform the srf_articleshform to set
	 */
	public void setSrf_articleshform(String srf_articleshform) {
		this.srf_articleshform = srf_articleshform;
	}
	/**
	 ...
	 * @return the srf_qty
	 */
	public String getSrf_qty() {
		return srf_qty;
	}
	/**
	 * @param srf_qty the srf_qty to set
	 */
	public void setSrf_qty(String srf_qty) {
		this.srf_qty = srf_qty;
	}
	/**
	 * @return the srf_unit
	 */
	...
	/**
	 * @return the srf_price
	 */
	public String getSrf_price() {
		return srf_price;
	}
	/**
	 * @param srf_price the srf_price to set
	 */
	public void setSrf_price(String srf_price) {
		this.srf_price = srf_price;
	}
	/**
	...
	/**
	 * @return the srf_rateamt
	 */
	public String getSrf_rateamt() {
		return srf_rateamt;
	}
	/**
	 * @param srf_rateamt the srf_rateamt to set
	 */
	public void setSrf_rateamt(String srf_rateamt) {
		this.srf_rateamt = srf_rateamt;
	}
	/**
